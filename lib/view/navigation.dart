...
import 'package:age_recog_pkl/view/kamera_page.dart';
import 'package:age_recog_pkl/view/data_page.dart';
...
class _NavigationState extends State<Navigation> {
  ...
  final List<Widget> currentPage = const [HomePage(), KameraPage(), DataPage()];
